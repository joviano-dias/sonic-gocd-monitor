var config = {
    ...
    port: process.env.gocdmonitor_port || 8080,
    ...
    goServerUrl: process.env.gocdmonitor_gocd_host || 'http://02.gocd.tools.engineering',
    ...
    goPollingInterval: process.env.gocdmonitor_gocd_poll_interval || 10,
    ...
    hideWeatherIcons: process.env.gocdmonitor_hide_weather_icons === 'false',
    enableDarkTheme: true,
    hideWeatherIcons: false,
